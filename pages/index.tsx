        ...
        <div className="grid-cols-1 mx-auto my-auto">
          ...
          <div className="my-2">
            <textarea
              ...
              id="OpenAI Key"
              autoComplete="key"
              className="w-full h-full my-2 rounded-md px-2 py-2 border dark:border-none text-gray-900 dark:text-white dark:bg-neutral-700 dark:focus:ring-black"
            />
            <br></br>
            <Link
              href="app/"
              onClick={handleSend}
              className="block w-auto rounded-md bg-blue-600 px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
            >
              Go to app
            </Link>
          </div>
